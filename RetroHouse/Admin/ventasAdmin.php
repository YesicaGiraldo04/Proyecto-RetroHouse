...
<body>
    <?php
        ...
        if(isset($_SESSION['user_rol']) && $_SESSION['user_rol'] == 1){
            $consulta = $conn->prepare("SELECT venta.*, usuario.nombreCompleto, usuario.direccion FROM venta INNER JOIN usuario ON venta.documentoUsuario = usuario.documentoCliente;");
            $consulta->execute();
                                    ...
                                    <?php
                                        foreach($compras as $x => $x_value){
                                            ...
                                            <tr>
                                                ...
                                                <td>".$x_value['fecha']."</td>
                                                <td>".$x_value['total']."</td>
                                                <td>".$x_value['documentoUsuario']."</td>
                                                <td>".$x_value['nombreCompleto']."</td>
                                                <td>".$x_value['direccion']."</td>
                                                <td>
                                                    <form action='detallesVenta.php' method='POST'>
                                                        <input type='number' name='idVenta' value='".$x_value['idVenta']."'hidden>
