...
<body>
    <?php
        ...
        if(isset($_SESSION['user_rol']) && $_SESSION['user_rol'] == 1){
            $idCompra = htmlentities($_POST['idCompra']);
            $consulta = $conn->prepare("SELECT detallecompra.idDetalleCompra, detallecompra.cantidad, detallecompra.precioUnitario,detallecompra.idCompra, producto.nombreProducto FROM detallecompra INNER JOIN producto ON detallecompra.idProducto = producto.idProducto WHERE idCompra = :idCompra");
            $consulta->execute([":idCompra" => $idCompra]);
                        ...
                        <div class="tablas p-3">
                            <div class="row">
                                <div class="col d-grid gap-2">
                                    <button class="btn btn-secondary my-3" onclick="window.location='comprasAdmin.php'">Regresar</button>
                                </div>
                            </div>
